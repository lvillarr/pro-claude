...
- El plan de reentrenamiento es obligatorio: los modelos se degradan con el tiempo sin datos nuevos
- Versionar el modelo con metadatos completos: en 6 meses nadie recordará con qué datos se entrenó
- La revisión de rendimiento a 90 días es obligatoria para detectar degradación de modelo (model drift)
