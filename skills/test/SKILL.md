...
> **Agente:** IA — Inteligencia Artificial. EO y TD tienen implementaciones propias en `agentes/EO/skills/test/` y `agentes/TD/skills/test/`.
...
**Prerequisito:** build completado con modelos entrenados y entregables generados.
