...
| `spec` | Especificación de iniciativas TD: proceso a digitalizar, sistemas involucrados, MVP y KPIs de éxito — ver `skills/spec/SKILL.md` |
| `plan` | Planificación técnica: arquitectura de integración, fases de implementación, dependencias de TI y riesgos — ver `skills/plan/SKILL.md` |
| `build` | Implementación: scripts ETL, conectores de API, telemetría de dealers, sincronización offline/online — ver `skills/build/SKILL.md` |
| `test` | Validación de integraciones: integridad de datos, manejo de errores, pruebas de conectividad adversa, KPIs — ver `skills/test/SKILL.md` |
| `review` | Revisión técnica: seguridad de código, idempotencia, calidad de datos en producción, mantenibilidad — ver `skills/review/SKILL.md` |
| `ship` | Cierre de iniciativas TD: documentación operacional, hand-off a TI, versionado, lecciones aprendidas — ver `skills/ship/SKILL.md` |
| `office-files` | Lectura y edición de `.xlsx`, `.docx`, `.pptx` y `.pdf` para consumir specs técnicas y generar documentación — ver `skills/office-files/SKILL.md` |
